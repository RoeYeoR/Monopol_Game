...
{   
    ...
    //edge square
    setSquare(0,0,std::make_shared<EdgeSquare>("FREE PARKING"));
    ...
    //edge square
    setSquare(0,10,std::make_shared<EdgeSquare>("GO TO JAIL"));
    ...
    setSquare(9, 10, std::make_shared<Street>("BOARDWALK", 400,Color::Blue,100));
     ...
     //edge square
    setSquare(10,10,std::make_shared<EdgeSquare>("START"));
    ...
    //edge square
    setSquare(10,0,std::make_shared<EdgeSquare>("VISITING"));
